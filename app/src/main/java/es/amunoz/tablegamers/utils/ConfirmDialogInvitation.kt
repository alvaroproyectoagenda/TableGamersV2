 ...
 *
 */
class ConfirmDialogInvitation(private var myContext: Context,   var message: String): View.OnClickListener  {

    private var dialog: Dialog = Dialog(myContext)
    private lateinit var buttonOK: Button
    private lateinit var buttonNO: Button
    private lateinit var listener: OnClickListenerConfirmDialogInvitation
    init {
        loadDialog()
    }
    ...
    fun setOnClickListenerOKButton(listener: OnClickListenerConfirmDialogInvitation) {
        this.listener = listener
    }
    fun setOnClickListenerNOButton(listener: OnClickListenerConfirmDialogInvitation) {
        this.listener = listener
    }
...
interface OnClickListenerConfirmDialogInvitation {
    fun onClickOKButton()
    fun onClickNOButton()
}
